          ...
          {SERVICES_DATA.map((service: ServiceItem, index: number) => {
            ...
            return (
              <motion.div
                ...
                key={service.id}
                className="bg-surface-container-low hover:bg-surface-container transition-all duration-300 group border-b border-outline/10 flex flex-col"
              >
                <div 
                ...
                >
                  ...
                  <div className="flex items-center gap-4 self-end md:self-center shrink-0">
                    ...
                    <button
                      ...
                      className="px-5 py-2 bg-surface-container-high group-hover:bg-primary group-hover:text-on-primary font-label-caps text-xs uppercase tracking-wider transition-all duration-200 flex items-center gap-2 cursor-pointer shadow-sm text-on-surface"
                    >
                      <span>INQUIRE</span>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    ...
                    >
                      <div className="px-6 pb-6 pt-1 md:pl-24 bg-surface-container-low/70 border-t border-outline/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                          <span className="font-label-caps text-[11px] text-primary uppercase tracking-widest block mb-2 font-bold">
                            Archival Inclusions:
                          </span>
